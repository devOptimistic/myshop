...
<body>
    <main class="container">
        ...
        <form class="col-6 offset-3" method="post">
            <h1 class="text-center">ویرایش کاربر</h1>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="phone" class="form-control" id="phone" name="phone" value="<?php if(isset($row['phone'])) echo $row['phone'];?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="address" rows="3" name="address" ><?php if(isset($row['address'])) echo $row['address'];?></textarea>
            </div>
            <div class="mb-3">
